...
int main()
{
    ...
    printf("--------------------------------\n");
    printf("sizeof(ngx_poo_t):%d, sizeof(ngx_pool_data_t):%d\n",sizeof(ngx_pool_t),sizeof(ngx_pool_data_t));
    printf("--------------------------------\n");
    
    printf("--------------------------------\n");
    printf("create a new pool:\n");
    printf("pool = ngx_create_pool(1024, NULL)\n");
    printf("--------------------------------\n");
